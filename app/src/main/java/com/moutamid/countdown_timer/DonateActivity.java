...
public class DonateActivity extends AppCompatActivity implements BillingProcessor.IBillingHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bp = BillingProcessor.newBillingProcessor(this, com.moutamid.countdown_timer.Constants.LICENSE_KEY, this);
        bp.initialize();
/*
    ...
    public void onProductPurchased(@NonNull String productId, @Nullable PurchaseInfo details) {
        ...
        if (productId.equals( com.moutamid.countdown_timer.Constants.TWO_HUNDRED_DOLLAR_PRODUCT))
            textView.setText("Two hundred tokens purchased");
        if (productId.equals( com.moutamid.countdown_timer.Constants.TWO_TWENTY_FIVE_DOLLAR_PRODUCT))
            textView.setText("Two twenty five tokens purchased");
        if (productId.equals( com.moutamid.countdown_timer.Constants.TWO_FORTY_SIX_DOLLAR_PRODUCT))
            textView.setText("Two forty six tokens purchased");
        if (productId.equals( com.moutamid.countdown_timer.Constants.TWO_SIXTY_FIVE_DOLLAR_PRODUCT))
            textView.setText("Two sixty five tokens purchased");
        if (productId.equals( com.moutamid.countdown_timer.Constants.THREE_HUNDRED_DOLLAR_PRODUCT))
